-- | This module is stolen from the streaming-utils package, which in
-- turn modifies material in Renzo Carbonara\'s
-- <http://hackage.haskell.org/package/pipes-zlib pipes-zlib> package.
...
for :: Monad m => ByteString m r -> (B.ByteString -> ByteString m a) -> ByteString m r
