...
void streaming_commons_set_avail_in (z_stream *stream, unsigned char *buff, unsigned int avail)
{
	stream->next_in = buff;
	stream->avail_in = avail;
}

void streaming_commons_set_avail_out (z_stream *stream, unsigned char *buff, unsigned int avail)
{
